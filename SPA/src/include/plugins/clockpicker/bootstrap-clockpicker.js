...
(function() {
	...
	function ClockPicker(element, options) {
		...
		if (options.inline) {
			popover.addClass("clockpicker-inline");
		}
		...
		function mousedown(e, space) {
			...
			$doc.off(mouseupEvent).on(mouseupEvent, function(e) {
				...
				// callback here
				raiseCallback(self.options.changed, {
					hours: self.hours,
	...
	ClockPicker.prototype.locate = function() {
		var element = this.element,
			...
			offset = this.options.inline ? { top: 0, left: 0 } : element.offset(),
	...
	ClockPicker.prototype.toggleView = function(_view, delay) {
		var view = typeof _view === "string" ? _view : _view.view;
		if (_view.value) {
			this.hours = _view.value.hours;
			this.minutes = _view.value.minutes;
			this.spanHours.html(leadingZero(this.hours));
			this.spanMinutes.html(leadingZero(this.minutes));
		}
