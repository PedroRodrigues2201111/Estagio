		...
		return this.each(function () {
			...
			function _advanceInputGroup(parentelement) {
				...
				if (prev.hasClass("input-group-btn")) {
					...
					downhtml =
						'<span class="input-group-btn"><button tabindex="-1" class="' +
						settings.buttondown_class +
						' bootstrap-touchspin-down" type="button">' +
						settings.buttondown_txt +
						"</button></span>";
			...
			function _buildInputGroup() {
				...
				if (settings.verticalbuttons) {
					html =
						...
						settings.postfix +
						'</span><span class="input-group-btn-vertical"><button tabindex="-1" class="' +
						settings.buttondown_class +
						' bootstrap-touchspin-up" type="button"><i class="' +
						settings.verticalupclass +
						'"></i></button><button tabindex="-1" class="' +
						settings.buttonup_class +
					...
					html =
						'<div class="input-group bootstrap-touchspin"><span class="input-group-btn"><button tabindex="-1" class="' +
						settings.buttondown_class +
						' bootstrap-touchspin-down" type="button">' +
						settings.buttondown_txt +
						...
						'</span><span class="input-group-addon bootstrap-touchspin-postfix">' +
						settings.postfix +
						'</span><span class="input-group-btn"><button tabindex="-1" class="' +
						settings.buttonup_class +
						' bootstrap-touchspin-up" type="button">' +
						settings.buttonup_txt +
						"</button></span></div>";
			...
			function _bindEvents() {
				// #modifications
				const keyRegex = /[0-9\.\-]/;
				originalinput[0].addEventListener("keydown", function (e) {
					if (e.key === "Backspace" || e.key === "Delete" || e.key === "Tab")
						return;
					if (!keyRegex.test("" + e.key)) e.preventDefault();
				});
				// #modifications end
			...
			function _checkValue() {
				...
				if (settings.decimals > 0)
					returnval = returnval.toFixed(settings.decimals);
				// #modifications end
