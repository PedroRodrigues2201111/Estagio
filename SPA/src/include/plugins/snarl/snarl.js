...
;(function (window, document) {
    ...
    Snarl = {
        ...
        addNotification: function(options) {
            ...
            addNotificationHTML(id, options.colorClass, options.color);
    ...
    function addNotificationHTML(id, colorClass, color) {
        ...
        if(colorClass !== '')
            addClass(Snarl.notifications[id].element,colorClass);
            
        if(color !== ''){
            Snarl.notifications[id].element.style.background = color;
        }
    }
